    ...
    content={
      <>
        ...
        <p>
          ...
          interfacing, USB, HDMI ports, Wi-Fi, Bluetooth, and runs Linux-based
          operating systems like Raspberry Pi OS.
        </p>
        <p>
  ...
  <ArticleSection
    ...
    content={
      <>
        ...
        <p>Complete the initial setup wizard to set up:</p>
        <ul className="list-disc list-inside space-y-2">
        ...
        <p>Enable SSH or VNC if you want to control the Pi remotely.</p>
      </>
    }
  />
