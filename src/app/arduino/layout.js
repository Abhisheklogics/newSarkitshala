...
// /* === CSS CLASS CONSTANTS === */
// /* === Enhanced, Responsive, Modern Layout CSS === */

// const layoutWrapper =
//   "min-h-screen  text-gray-900 grid grid-cols-1 lg:grid-cols-[259px_1fr_240px] pt-24 gap-6 transition-all duration-300 ease-in-out";

// const sidebarWrapper =
//   "z-40 h-[calc(100vh-6rem)] w-[330px] overflow-y-auto  border-r border-gray-200 px-5 py-6 shadow-md rounded-tr-2xl rounded-br-2xl transition-all duration-300 ease-in-out lg:static lg:block";

// const sidebarCloseBtn =
//   "lg:hidden mb-4 mt-2 text-sm text-red-600 hover:text-red-800 font-semibold self-end transition duration-300";

// const toggleBtnClass =
//   "w-full text-left px-4 py-2 rounded-xl bg-white border border-gray-300 hover:bg-blue-50 shadow-sm transition duration-200";

// const toggleBtnText =
//   "font-semibold text-base text-gray-800 truncate";

// const toggleLinksList =
//   "space-y-2 mt-4 pl-6 border-l-2 border-blue-300";

// const toggleLinkItem =
//   "block bg-white border border-gray-300 rounded-md px-4 py-2 text-gray-800 hover:text-orange-500 hover:shadow-lg transition-all duration-200";

// const mobileMenuBtn =
//   "lg:hidden fixed top-24 left-4 z-40 p-3 bg-blue-600 text-white rounded-lg shadow-xl transition-transform duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400";

// const mainContent =
//   "col-span-1 w-full max-w-4xl mx-auto p-6  md:p-1 md:ml-18  rounded-2xl  transition-all duration-300";
...
//         {sidebarOpen ? 'Close' : 'Show Experiments'}
//       </button>
